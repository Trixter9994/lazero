...
if [ $candidates -gt 0 ]; then
	...
	sudo echo 5000 > $tardir/blitx/cpu.cfs_quota_us
	sudo echo 50000 > $tardir/blitx/cpu.cfs_period_us
	# do the stuff then.
...
#	echo "No candy"
	...
	if get_kernel; then
		...
		# really? not know.
		sudo echo 10000 > $default_cpu/blitx/cpu.cfs_quota_us
		sudo echo 50000 > $default_cpu/blitx/cpu.cfs_period_us
		# do the stuff then.
		# return the directory, for future use.
